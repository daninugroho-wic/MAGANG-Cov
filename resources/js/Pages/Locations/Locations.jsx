...
export default function Lokasi() {
    ...
    const updateMapLocation = async (lat, lon, displayName) => {
        ...
        newMarker.on("dragend", async (event) => {
            ...
            const updatedDisplayName = await getAddressFromCoordinates(
                updatedLat,
                updatedLon
            );
    ...
    const handleSubmit = (e) => {
        ...
        Inertia.visit(
            `/packages?location_maps=${encodeURIComponent(
    ...
    return (
                    ...
                    <div className="container mx-auto py-8 md:py-12 text-center">
                        ...
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-4 md:mb-6 text-gray-800 relative">
                            <span className="relative z-10">
                                Cek Apakah Lokasi Anda Termasuk Dalam Jangkauan
                                Kami
                            </span>
                        ...
                        <p className="text-base md:text-lg mb-6 md:mb-8 text-gray-700 hover:text-gray-900">
                            Masukkan Alamat Pemasangan Anda (Disarankan
                            menggunakan Titik Koordinat Lokasi Anda)
                        </p>
        ...
        <ul
            className="absolute z-50 w-full bg-white shadow-md rounded-lg max-h-60 overflow-auto border border-gray-200"
        ...
        >
            {searchResults.map((result, index) => (
                <li
                    ...
                    onClick={() =>
                        handleSelectLocation(result.lat, result.lon, result.display_name)
                    }
                >
                    {result.display_name}
                </li>
    ...
    <div
        id="map"
        className="map-container border border-gray-200 shadow-lg w-full h-72 md:h-96 rounded-lg mb-6 relative z-10"
    ></div>
</div>
                        {locationDetails && (
